...
import { CalendarDays, Download, Inbox, LogOut, Mail, RefreshCw, Search, Trash2, Users } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  async function removeRecord(type: "enquiry" | "subscriber", id: number, label: string) {
    ...
    if (!response.ok) return window.alert("The record could not be deleted. Please try again.");
    if (type === "enquiry") setSelected(null);
    await load();
  }
