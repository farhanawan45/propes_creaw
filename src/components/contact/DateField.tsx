      ...
      <Popover.Root open={open} onOpenChange={setOpen}>
        <Popover.Trigger asChild>
          <button
            type="button"
            id="eventDate"
            className={`flex h-14 w-full items-center justify-between rounded-[14px] border bg-[rgba(245,241,232,0.04)] px-[18px] text-left text-base outline-none transition-colors focus:ring-[3px] ${
