      ...
      <Popover.Root open={open} onOpenChange={setOpen}>
        <Popover.Trigger asChild>
          <div
            ...
            className={`flex h-14 w-full cursor-pointer items-center gap-2 rounded-[14px] border bg-[rgba(245,241,232,0.04)] px-[18px] outline-none transition-colors focus:ring-[3px] ${
              error
